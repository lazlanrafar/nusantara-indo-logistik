<template>
  <header>
    <div class="container flex mx-auto">
      <a href="#" class="">info@nusantaraindologistikbatam.com</a>
      <a href="">0778-4103641</a>
      <a href="">8:00AM to 5:00PM</a>
    </div>
    <nav class="bg-white sm:px-4 dark:bg-gray-800">
      <div
        class="container flex flex-wrap justify-between items-center mx-auto py-5"
      >
        <a href="#" class="flex">
          <svg
            class="mr-3 h-10"
